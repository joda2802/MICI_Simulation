...
mesh_name = "Mesh_Geometry_Brunt2_mittel"
gdim = 2 #Dimension
h_size = 0.1 # Legt Größe der Gitternetzpunkte fest 
...
#Tags - wähle je nach Geometrie des csv files den richtigen Block aus, der Rest bleibt auskommentiert 
